...
{
    public class DepartmentDtoAndViewmodelDxo : IDepartmentDtoAndViewmodelDxo
    {
        ...
        public DepartmentDto ExchangeViewmodelToDto(DepartmentViewModel departmentViewModels)
        {
            var mapper = viewmodelToDtoOverride.CreateMapper();
            return mapper.Map<DepartmentViewModel, DepartmentDto>(departmentViewModels);
        }
        #endregion
